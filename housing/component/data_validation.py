...
class DataValidation:
    ...
    def validate_dataset_schema(self)->bool:
        try:
            ...
            #1.Number of column
            #2.check the values of ocean proximity column
            #acceptble values <1H OCEAN
            #INLAND
            #ISLAND
            #NEAR BAY
            #NEAR OCEAN
    ...
    def get_and_save_data_drift_report(self):
        try:
            ...
            # profile.json()-->It returns the json object as type string
            report = json.loads(profile.json())#It converts json object to dictionary or list format
    ...
    def intiate_data_validation(self)->DataValidationArtifact:
        try:
            ...
            data_validation_artifact = DataValidationArtifact(
                ...
                report_page_file_path=self.data_validation_config.report_page_file_path,
                is_validated=True,
                message="Data Validation Perfomed Successfully."
            )
